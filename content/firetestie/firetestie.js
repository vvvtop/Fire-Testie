    ...
    fireTestiePanel.prototype = extend(Firebug.Panel,function(){
        var document,readyTimeout,context,styleSheet,ftBox,tmpDoc,
            ...
            start=function(){
                ...
                for(x in document.defaultView.frames){
                    document.defaultView.frames[x].document.addEventListener("mouseover",onInspectingMouseOver,true);
                    document.defaultView.frames[x].document.addEventListener("mouseout",onInspectingMouseOut,true);
                }
            ...
            onInspectingMouseOver=function(e){
                /* if(document!==e.currentTarget){
                    e.currentTarget.addEventListener("mouseover",onInspectingMouseOver,true);
                    e.currentTarget.addEventListener("mouseout",onInspectingMouseOut,true);

                } */
                
                Firebug.Console.log(e.currentTarget);
                Firebug.Inspector.highlightObject(e.target,context,HIGHLIGHTTYPE,BOXFRAME,"green");
                e.currentTarget.addEventListener("click",onInspectingClick,true);
